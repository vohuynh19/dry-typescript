...
export interface FlippingPagesWithPerspectiveProps
  extends FlippingPagesCoreProps {
  perspectiveMultiplier?: number | undefined;
}

export const defaultPerspectiveMultiplier = 2;

const _FlippingPagesWithPerspective = (
  props: FlippingPagesWithPerspectiveProps,
) => {
  const { direction, perspectiveMultiplier = defaultPerspectiveMultiplier } =
    props;
