...
export interface FlippingPagesWithPointerControlsProps
  extends FlippingPagesWithAnimationProps {
...
const _FlippingPagesWithPointerControls = (
  props: FlippingPagesWithPointerControlsProps,
) => {
  const {
    children,
    direction,
  ...
  const { cancelPointer, pointerDown, ..._pointerEventListeners } =
    usePointerEvents({
      onDown,
      onMove,
      onUp,
...
export const FlippingPagesWithPointerControls = memo(
  _FlippingPagesWithPointerControls,
);
